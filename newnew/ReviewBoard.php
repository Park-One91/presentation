					...
					<header id="header">
						...
						<div class="content">
							<div class="inner">
								...
								<ul class="actions">
										<li><a href="#" class="button primary">ALL</a></li>
										<li><a href=".\ReviewBoard_mine.php" class="button">MY</a></li>
									</ul>
                          ...
                          <th>Movie</th>
									...
									<div >
                    <button  class="button small" onclick="boardWrite()" type="button">Make Review</button></p>
                	</div>
