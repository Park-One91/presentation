						...
						<div class="content">
							<div class="inner">
								...
								<form method="POST" action="join_result.php">
									<p style="color:#f77777;">- (*)표시는 필수 입력사항 입니다 -</p>
									<div class="point">
										* 아 이 디 : &nbsp&nbsp
										<input type="text" style="width: 200px; height: 25px;" id="joinId" name="id" value=""> &nbsp&nbsp
										<button onclick="idCheck()" class="favorite styled" style="height: 25px; width: 100px; line-height : 20px; font-size: 15px;" type="button">중복체크</button>
									</div>
									<font style="color:#9cdcfe;" size="1.5">＊6~15자의 영문 소문자, 숫자만 가능합니다</font>
									<div class="point">
										* 비밀번호 : &nbsp&nbsp
										<input type="password" style="width: 200px; height: 25px;" name="pw" value="">	
									</div>
									<font style="color:#9cdcfe;" size="1.5">＊영문자, 숫자, 특수문자의 조합, 8자리 이상으로 이루어져야 합니다</font>
									<div class="point">
									* 비밀번호 확인 : &nbsp&nbsp
									<input type="password" style="width: 200px; height: 25px;" name="pw_r" value="">
									</div>
									<div class="point">
									* 이    름 : &nbsp&nbsp
									<input type="text" style="width: 200px; height: 25px;" name="name" value="">
									</div>
									<div class="point">
									* 연 락 처 : &nbsp&nbsp
									<input type="text" style="width: 200px; height: 25px;" name="hp" value="">
									</div>
									<div class="qwe">
										이 메 일 : &nbsp&nbsp&nbsp&nbsp
										<input type="text" style="width: 200px; height: 25px;" name="email" value="">&nbsp&nbsp&nbsp&nbsp
										@&nbsp&nbsp
										<select name="email_domain" style="width: 200px; height: 25px;">
